...
public:
   ...
   */
    ...
    virtual antlrcpp::Any visitExpr(MainParser::ExprContext *context) = 0;

    virtual antlrcpp::Any visitType(MainParser::TypeContext *context) = 0;

    virtual antlrcpp::Any visitNumber(MainParser::NumberContext *context) = 0;
