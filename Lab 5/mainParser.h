...
public:
  ...
  enum {
    ...
    RuleCompound_stmt = 9, RuleStmt = 10, RuleStmt_list = 11, RuleAssignment_stmt = 12, 
    RuleRepeat_stmt = 13, RuleIf_stmt = 14, RuleFunction = 15, RuleVariable = 16, 
    RuleExpr = 17, RuleNumber = 18, RuleSign = 19, RuleMul_div_op = 20, 
