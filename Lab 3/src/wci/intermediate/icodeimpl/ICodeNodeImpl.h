...
constexpr ICodeNodeTypeImpl NT_SELECT_BRANCH = ICodeNodeTypeImpl::SELECT_BRANCH;
constexpr ICodeNodeTypeImpl NT_SELECT_CONSTANTS = ICodeNodeTypeImpl::SELECT_CONSTANTS;
