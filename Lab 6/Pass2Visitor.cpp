...
//antlrcpp::Any Pass2Visitor::visitMainBlock(MainParser::MainBlockContext *ctx)
//{
...
//}
//
//antlrcpp::Any Pass2Visitor::visitAssignmentStmt(MainParser::AssignmentStmtContext *ctx)
//{
...
//}
//
//antlrcpp::Any Pass2Visitor::visitFloatConst(MainParser::FloatConstContext *ctx)
//{
//    // Emit a load constant instruction.
//    j_file << "\tldc\t" << ctx->getText() << endl;
//
