...
enum class CPPTokenType
{
    ...
    FILE, FOR, FUNCTION, GOTO, IF, IN, LABEL, NIL, NOT,
    ...
    // Special symbols.
	TILDE, EXCLA_POINT, AT, MOD, CARET, AMPERSAND, STAR, MINUS, PLUS, EQUALS, FORWARDSLASH, COLON, SEMICOLON, QUESTION_MARK,
	...
	COMMENT_CLOSED_AST, LEFT_PAREN, RIGHT_PAREN, LEFT_BRACKET, RIGHT_BRACKET, LEFT_BRACE, RIGHT_BRACE, NEW_LINE, TAB_SPACE,
...
constexpr CPPTokenType PT_TAB_SPACE= CPPTokenType::TAB_SPACE;
